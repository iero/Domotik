...
#define WATCHDOG_PIN 11 // Heartbeat for WatchDog
#define LED_PIN 13 // LED for heart beat

#define PULSE_DELAY 500 // delay for "for loop" (ms)
...
void loop() {
  ...
  // Send watchdog signal and wait before continuing
  digitalWrite(LED_PIN, HIGH);
  digitalWrite(WATCHDOG_PIN, HIGH);
  delay(PULSE_DELAY); // wait enough time to allow watchdog to see the signal
